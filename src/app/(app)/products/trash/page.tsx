import { ProductsTrashListView } from "@/modules/products/presentation/components/products-trash-list-view";
import {
  PRODUCT_SORT_FIELDS,
  PRODUCT_SORT_ORDERS,
